...
<head>
	...
	<title>Ch&agrave;o m&#7915;ng b&#7841;n &#273;&#7871;n v&#7899;i Ch&uacute; B&eacute; R&#7891;ng Online - &#272;&#259;ng K&yacute; T&agrave;i Kho&#7843;n</title>
			...
			<div class="link-more">
				<div class="h" align="center">
					...
					<div class="body" style="text-align:center">
						<div style="font-size:10px;">&#272;&#259;ng k&yacute; t&agrave;i kho&#7843;n Ch&uacute; B&eacute; R&#7891;ng Online m&#7899;i.</div>
						<center>
							<form id="registerForm" method="POST" name="register">
								...
								<button type="submit" class="w3-button w3-red" value="&#272;&#259;ng K&yacute;" id="button1" name="submit">&#272;&#259;ng K&yacute;</button><br />
								<div style="font-size:10px;">
									(&#272;&atilde; c&oacute; t&agrave;i kho&#7843;n?)<br>
									<a href="login" class="auth-link-button">&#272;&#259;ng Nh&#7853;p</a>
								</div>
							</form><br>
						</center>
					</div>
...
$(document).ready(function() {
    $('#registerForm').submit(function(e) {
        e.preventDefault(); // NgÄƒn cháº·n form submit theo cĂ¡ch thĂ´ng thÆ°á»ng

        var form = $(this);
        // Äáº£m báº£o URL nĂ y khá»›p vá»›i tĂªn file PHP cá»§a báº¡n
        // Náº¿u file PHP cá»§a báº¡n lĂ  "auth_process.php", hĂ£y Ä‘á»•i thĂ nh 'auth_process.php'
        var url = 'register_process.php'; 

        $.ajax({
            type: "POST",
            url: url,
            data: form.serialize(), // Gá»­i táº¥t cáº£ dá»¯ liá»‡u tá»« form
            dataType: "json", // Mong Ä‘á»£i pháº£n há»“i JSON tá»« server
            success: function(response) {
                var messageDiv = $('#registerMessage');
                messageDiv.css('display', 'block'); // Hiá»ƒn thá»‹ div thĂ´ng bĂ¡o
                messageDiv.removeClass('success error'); // XĂ³a cĂ¡c class cÅ©
                ...
                if (response.status === 'success') {
                    ...
                    if (response.redirect) {
                        setTimeout(function() {
                            window.location.href = response.redirect; // Chuyá»ƒn hÆ°á»›ng sau 1.5 giĂ¢y
                        }, 1500);
                    }
                } else {
            ...
            error: function(jqXHR, textStatus, errorThrown) {
                ...
                messageDiv.addClass('error');
                messageDiv.text('Da xay ra loi ket noi. Vui long thu lai sau. (Ma loi: ' + jqXHR.status + ')');
            }
        });
    });
});
